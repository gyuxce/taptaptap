...
export const AdminSidebar: React.FC<SidebarProps> = ({ className, onCloseMobile }) => {
  ...
  return (
    <aside className={`w-[240px] bg-slate-900 border-r border-slate-800 flex flex-col justify-between h-screen sticky top-0 text-slate-200 shrink-0 ${className}`}>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3.5 px-4 py-3 rounded-xl text-xs font-bold transition-all duration-200 ${
                  isActive
                    ? 'bg-[#1D9E75] text-white shadow-lg shadow-[#1D9E75]/15'
